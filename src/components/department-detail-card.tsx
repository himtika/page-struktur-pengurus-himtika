...
function DepartmentDetailCard({
  ...
  return (
    <li
      className={`z-20 w-[80%] md:w-full max-w-28 lg:max-w-36  bg-primary rounded-xl flex flex-col gap-3 justify-evenly items-center px-1 pt-1 pb-3 relative`}
    >
      ...
      <button
        className="w-[80%] text-black bg-yellow-200 rounded-full text-[0.700rem]"
        onClick={setModalOpened.bind(null, departemen)}
      >
        Detail
      </button>
    </li>
